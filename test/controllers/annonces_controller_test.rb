...
class AnnoncesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create annonce" do
    assert_difference("Annonce.count") do
      post annonces_url, params: { annonce: { content: @annonce.content, title: @annonce.title, user_id: @annonce.user_id } }
    end
  ...
  test "should update annonce" do
    patch annonce_url(@annonce), params: { annonce: { content: @annonce.content, title: @annonce.title, user_id: @annonce.user_id } }
